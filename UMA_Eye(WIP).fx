...
float4 _MainParam[] = { float4(0, 0, 0, 0), float4(0, 0, 0, 0) };//左右眼偏移
float4 _HighParam1[] = { float4(0, 0, 0, 1) , float4(0, 0, 0, 1) , float4(0, 0, 0, 0) };//左眼上高光（w值为强度）、左眼下高光、双眼闪烁效果
float4 _HighParam2[] = { float4(0, 0, 0, 1) , float4(0, 0, 0, 1) };//右眼上高光、右眼下高光

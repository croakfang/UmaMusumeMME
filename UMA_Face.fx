...
float4 _FaceCenterPos :CONTROLOBJECT < string name = "model.pmx"; string item = "һ"; > ; //replace name to your model filename (Shift-JIS)
float3 _FaceUp = float3(0, 1, 0);
float4x4 _faceShadowHeadMat : CONTROLOBJECT < string name = "model.pmx"; string item = "һ"; > ;
float3 _FaceForward = float3(0, 0, 1); 
